...
Call the Skill tool with `clean-mode` before writing issue comments or agent-ready briefs. Put the decision, status, and next action first, then include only the detail needed to support it.
