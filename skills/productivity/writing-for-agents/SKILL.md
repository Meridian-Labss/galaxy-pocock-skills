...
When the document is also a durable human-facing project artefact, call the Skill tool with `clean-mode` and apply both references. `clean-mode` owns human speed-reading; this skill owns agent-facing behaviour.
